...
const ButtonRef = React.forwardRef<
    HTMLButtonElement,
    React.ComponentProps<"button"> &
    VariantProps<typeof buttonVariantsRef> & {
  asChild?: boolean
}
>(({ className, variant, size, asChild = false, ...props }, ref) => {
  ...
  return (
      <button
          ref={ref}
          className={cn(buttonVariantsRef({ variant, size, className }))}
          {...props}
      />
  )
});
...
export { Button, ButtonRef, buttonVariants, buttonVariantsRef }
